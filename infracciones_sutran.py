...
resp_HomeInfraccion = requests.request("GET", URL_SUTRAN_HOME_INFRACCION)
...
for c in captcha:
    if c.isascii() is False:
        ...
        c = "Ñ"
        # print(c)
    list_nuevo_captcha.append(c)

nuevo_captcha = "".join(list_nuevo_captcha)
# print(nuevo_captcha)
# Placa BDN910 con papeleta
...
payload_InfoPapeleta = '__EVENTTARGET=&__EVENTARGUMENT=&__LASTFOCUS=&__VIEWSTATE=' + urllib.parse.quote(viewstate, safe="") + '&__VIEWSTATEGENERATOR=' + viewstategenerator + '&__EVENTVALIDATION=' + urllib.parse.quote(
    eventvalidation, safe="") + '&ddlTipoBusqueda=2&TxtBuscar=&txtPlaca=' + placa + '&HFCodCapcha=&TxtCodImagen=' + captcha + '&BtnBuscar=Buscar&HdfModal2=&txtCorreo='
