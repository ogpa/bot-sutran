...
def listar_correos(papeletas, endpoint, api_key):
    ...
    for c_u in lista_clientes_unicos:
        ...
        for c_l in x:
            if lista_clientes[c_l] == c_u:
                ...
                fecha_documento = datetime.datetime.strptime(
                    papeletas["fechadocumento"][c_l], "%Y-%m-%d").strftime("%d/%m/%Y")
                lista_temp_html.append([papeletas["placa"][c_l], fecha_documento, papeletas["montoinfraccion"]
                                       [c_l], papeletas["montoprontopago"][c_l], papeletas["numdocumento"][c_l], papeletas["entidad"][c_l]])
        ...
        papeletas_con_correo = agregar_correos_dict(
            papeletas, c_u, lista_correos)
