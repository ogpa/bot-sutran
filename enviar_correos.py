...
CABECERAS_TABLA = ["Placa", "Fecha", "Monto",
                   "Monto pronto pago", "Número de papeleta", "Entidad"]
...
<body>
  <h1>Nuevas papeletas al """ + hoy + """</h1>
  <p>Lista de nuevas papeletas</p>
      """ + tabla_html + """
...
def enviar_correos(lista_para_enviar_correos):
    ...
    for x in lista_para_enviar_correos:
        ...
        correos_destinarios_incluido_diego.append("dpizarro@mb-renting.com")
